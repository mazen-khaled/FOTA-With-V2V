...
My primary responsibility was developing a bootloader capable of receiving firmware updates over-the-air (OTA) from an ESP microcontroller and designing a PCB for the project.
